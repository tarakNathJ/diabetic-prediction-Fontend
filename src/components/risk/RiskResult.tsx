...
export default function RiskResult() {
  ...
  const getRiskLevel = () => {
    if (XgBoost == "Diabetic" && Randomforest == "Diabetic") return { level: 'High', color: 'text-red-400', bg: 'bg-red-400/10' };
    if (XgBoost != Randomforest) return { level: 'Moderate', color: 'text-yellow-400', bg: 'bg-yellow-400/10' };
